...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "HUDTenant.controller.InitData": [],
  "HUDTenant.controller.Pha": [],
  ...
  "HUDTenant.store.DataStore": [],
  "HUDTenant.store.FMRStore": [],
  "HUDTenant.store.IncomeLimits": [],
  "HUDTenant.store.OptionsStore": [],
  "HUDTenant.store.PhaStore": [],
  "HUDTenant.store.StateStore": [],
  "HUDTenant.view.ContactUs": [],
  "HUDTenant.view.FMRForm": [],
  "HUDTenant.view.FMRs": [],
  "HUDTenant.view.IncomeLimits": [],
  "HUDTenant.view.Instructions": [],
  "HUDTenant.view.Main": [],
  "HUDTenant.view.MainView": [],
  "HUDTenant.view.Options": [],
  "HUDTenant.view.PDF": [],
  "HUDTenant.view.PhaForm": [],
  "HUDTenant.view.PhasView": [],
  "HUDTenant.view.Report50058": [],
  "HUDTenant.view.TellAFriend": [],
  "HUDTenant.view.TenantView": []
});
