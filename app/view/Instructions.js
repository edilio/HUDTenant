...
Ext.define("HUDTenant.view.Instructions", {
    ...
    config: {
        ...
        html: [
            ...
            'var view = Ext.getCmp(',
            "'instructions-view'); return view.display50058();",
            '">',
            'Download 50058 form(HUD official form)</a></p>'
        ].join("")

    },
    display50058Moz : function (){
    ...
    display50058Browser: function(){
        window.open('resources/pdfs/huddoc50058.pdf', '_blank', 'location=yes');
    ...
    display50058: function(){
        ...
        if (width > 480){
            this.display50058Moz();
        }
        else{
            this.display50058Browser();
        }
        return false;
    }
});
